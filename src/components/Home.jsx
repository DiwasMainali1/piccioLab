    ...
    <div id="home" className="bg-gray-100"> 
      ...
      <div className="py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white flex flex-col md:flex-row items-center justify-between rounded-2xl py-10 px-10 shadow-lg mb-20">
            <div className="w-full md:w-1/2 mb-8 md:mb-0">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 text-black">Introduction</h2>
              <p className="text-justify text-base md:text-lg text-black leading-relaxed">
            ...
            <div className="w-full md:w-1/2 flex justify-center">
              <img src={Laura} alt="Laura" className="w-3/4 h-auto rounded-xl shadow-lg" />
            </div>
          </div>
        </div>
      </div>
